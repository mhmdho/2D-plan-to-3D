...
doc1 = ezdxf.readfile("1/Trimmed/plan_4.dxf")
doc2 = ezdxf.readfile("1/Trimmed/plan_11.dxf")
doc3 = ezdxf.readfile("1/Trimmed/plan_8.dxf")
...
Wall_Texture = pv.Texture('wall.jpg')
Window_Texture = pv.Texture('window2.jpg')
Door_Texture = pv.Texture('door.png')
Roof_Texture = pv.Texture('roof.jpg')
Stair_Texture = pv.Texture('stair.jpg')
